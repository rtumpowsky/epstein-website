  ...
  return (
    <div className="min-h-screen bg-[#B87680]">
      ...
      <div className="py-12 px-2">
        ...
        <h3 className="text-center text-lg sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-bold italic text-white mb-12 px-2 md:px-4" style={{ fontFamily: 'Cambria, Georgia, serif' }}>
